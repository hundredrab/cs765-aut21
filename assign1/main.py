...
parser.add_argument("-z", "--slow_percent", type=float,
                    help="Percent of peers that are slow")
...
DATA_FOLDER = "data"
LOG_FILE = f"{DATA_FOLDER}/{NUM_PEERS}_{NUM_TRANS}_{INTERARRIVAL_MEAN}_{AVG_MINING_TIME}_{Z}.csv"
