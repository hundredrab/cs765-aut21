...
geth removedb
geth --datadir $HOME/Projects/cs765-aut21/assign3/test-eth1 --targetgaslimit '9000000000000' --rpc --rpcport=1558 --rpcapi "eth,net,web3,debug" --networkid=2310 --port=1547 --syncmode full --gcmode archive --nodiscover --nodekey=nk.txt init $HOME/Projects/cs765-aut21/assign3/genesis.json
